package com.freemind.timesheet.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.freemind.timesheet.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.freemind.timesheet.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.freemind.timesheet.domain.AppUser.class.getName());
            createCache(cm, com.freemind.timesheet.domain.AppUser.class.getName() + ".jobs");
            createCache(cm, com.freemind.timesheet.domain.Company.class.getName());
            createCache(cm, com.freemind.timesheet.domain.Company.class.getName() + ".appUsers");
